...
(
    ...
    localparam PAD3 = log2ceil(64'hd - 64'hc); 
    ...
    // ( 0x4 .. 0x8 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 18'h4  && write_transaction  ) begin
            src_channel = 10'b0000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x8 .. 0xc )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 18'h8  && write_transaction  ) begin
            src_channel = 10'b0000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0xc .. 0xd )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 18'hc  && write_transaction  ) begin
