	soc_system u0 (
		...
		.pe_address_export                     (<connected-to-pe_address_export>),                     //                     pe_address.export
		.pe_readdata_export                    (<connected-to-pe_readdata_export>),                    //                    pe_readdata.export
		.pe_writedata_export                   (<connected-to-pe_writedata_export>),                   //                   pe_writedata.export
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                          reset.reset_n
		.pe_write_export                       (<connected-to-pe_write_export>)                        //                       pe_write.export
	);
